...
\textbf{\circled{2} Half-pressure of the left-hand fingers } is prescribed using the \textbf{note heads} below: \\
\circled{1.} \includegraphics[scale=0.1]{half_harmonic_half_note.png} Half notes and larger durations. \\
\circled{2.} \includegraphics[scale=0.07]{half_harmonic_quarter_note.png} Quarter notes and shorter durations.\\
\\
\textbf{\circled{3} Bow-tip angle } is prescribed using the following symbols above the staff: \\
